...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-primary/90 rounded-md shadow-soft hover:shadow-soft-hover',
        destructive:
        ...
        pill: 'bg-primary text-primary-foreground hover:bg-accent rounded-full shadow-soft hover:shadow-soft-hover hover:scale-[1.02] active:scale-[0.98]',
      },
      size: {
