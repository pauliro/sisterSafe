...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "A miniapp to share location safely", // 30 characters, no emojis or special characters, short description under app name
      description: "A miniapp to share location safely", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "A miniapp to share location safely", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
